...
#### NPM
```
npm install apollo-ui@1.3.0 --save
```

#### Bower
```
bower install apollo-ui#1.3.0 --save
```
...
```
<link rel="stylesheet" href="//cdn.ims.io/design/css/1.3.0/apollo.min.css">
```
...
<script src="//cdn.ims.io/design/js/1.3.0/apollo.min.js"></script>
```
