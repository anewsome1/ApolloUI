...
#### NPM
```
npm install apollo-ui@1.0.0-beta.4 --save
```

#### Bower
```
bower install apollo-ui#1.0.0-beta.4 --save
```
...
```
<link rel="stylesheet" href="//cdn.ims.io/design/css/1.0.0-beta.4/apollo.min.css">
```
...
<script src="//cdn.ims.io/design/js/1.0.0-beta.4/apollo.min.js"></script>
```
